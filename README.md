...
Базовая задачаВам нужно создать приложение-счётчик. Его идея проста: в приложении должна быть одна большая кнопка. Сколько раз на неё нажали — такая цифра и отображается на счётчике.
...
Убедитесь, что после выполнения базовой задачи:Приложение запускается и не крашится;
